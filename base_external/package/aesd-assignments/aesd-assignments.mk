...
AESD_ASSIGNMENTS_VERSION = d9c644fbc5d4bec94ab90c45f339dfc6514d31ea
# Note: Be sure to reference the *ssh* repository URL here (not https) to work properly
# with ssh keys and the automated build/test system.
# Your site should start with git@github.com:
#AESD_ASSIGNMENTS_SITE = https://github.com/cu-ecen-aeld/assignments-3-and-later-zzggh7.git
AESD_ASSIGNMENTS_SITE = git@github.com:cu-ecen-aeld/assignments-3-and-later-zzggh7.git
...
define AESD_ASSIGNMENTS_BUILD_CMDS
	...
	$(MAKE) $(LINUX_MAKE_FLAGS) -C $(LINUX_DIR) M=$(@D)/aesd-char-driver modules
endef
